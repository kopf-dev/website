...
- **Required:** The Legal column must include `<a href="/impressum/" class="hover:text-white transition-colors">Impressum</a>` and `<a href="/datenschutz/" class="hover:text-white transition-colors">Datenschutz</a>`
